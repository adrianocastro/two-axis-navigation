...
Y.ScrollView = Y.extend(ScrollView, Y.Widget, {
    ...
    _onGestureMoveStart: function(e) {
        ...
        if (!sv._cDisabled) {
            ...
            sv._startClientX = e.clientX;
            sv._startClientY = e.clientY;
    ...
    _onGestureMove: function(e) {
        var sv = this, scrollsVertical;
        if (this._scrollsVertical == null) {
            this._scrollsVertical = (Math.abs(e.clientX - sv._startClientX) < Math.abs(e.clientY - sv._startClientY));
        }
        ...
        if (scrollsVertical) {
            var delta = -(e.clientY - sv._startClientY);
